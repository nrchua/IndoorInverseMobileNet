...
def parse_args():
    ...
    create_parser.add_argument('--deploy_src', type=str, help='deploy to target path', default='/Users/nickchua/.kube/indoorInverse-master/train/')
    # create_parser.add_argument('--deploy_s3', type=str, help='deploy s3 container', default='s3mm1:train/train')
    create_parser.add_argument('--deploy_tar', type=str, help='deploy to target path', default='/nickdata/indoorInverse/job_list')
    create_parser.add_argument('--deploy_train_path', type=str, help='deploy to target path', default='/nickdata/indoorInverse/train')
    create_parser.add_argument('--python_path', type=str, help='python path in pod', default='/nickdata/envs/py38/bin/python')
    create_parser.add_argument('--pip_path', type=str, help='python path in pod', default='/nickdata/envs/py38/bin/pip')
